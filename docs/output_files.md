...
## Save SNPs
See [here](https://snps.readthedocs.io/en/latest/output_files.html#save-snps).
...
:::{note}
If more than two individuals are compared, all {class}`~lineage.individual.Individual`
...
![Shared DNA plot example 1](https://raw.githubusercontent.com/apriha/lineage/main/docs/images/shared_dna_Parent_Child_0p75cM_1100snps_GRCh37_HapMap2.png)
...
![Shared DNA plot example 2](https://raw.githubusercontent.com/apriha/lineage/main/docs/images/shared_dna_Sibling1_Sibling2_0p75cM_1100snps_GRCh37_CEU.png)
...
In addition to the outputs produced by [Find Shared DNA](#find-shared-dna), up to two additional CSV files are
...
[shared_dna_one_chrom_\<name1\>\_\<name2\>\_\<cM_threshold\>cM_\<snp_threshold\>snps_GRCh37_\<genetic_map\>.csv](shared-dna-one-chrom).
...
[shared_dna_two_chroms_\<name1\>\_\<name2\>\_\<cM_threshold\>cM_\<snp_threshold\>snps_GRCh37_\<genetic_map\>.csv](shared-dna-two-chroms).

The file has the same columns as [shared_genes_one_chrom_\<name1\>\_\<name2\>\_\<cM_threshold\>cM_\<snp_threshold\>snps_GRCh37_\<genetic_map\>.csv](shared-genes-one-chrom).
