...
from lineage.generator import SyntheticRelatedGenerator as SyntheticRelatedGenerator
...
class Lineage:
    ...
    def _get_csv_header(self):
        return (
            ...
            f"# Generated at {datetime.datetime.now(datetime.timezone.utc).strftime('%Y-%m-%d %H:%M:%S')} UTC{os.linesep}"
        )
